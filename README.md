...
The optional `qlean-ci` test runs the installer validation and systemd/permission
checks inside a disposable Debian VM. It requires a Linux host with QEMU,
